...
export SCHOOL_READER_SERVICE_PORT=`kubectl get services | grep "school-reader" | awk '{ print $5 }' | awk -F"," '{ print$2 }' | awk -F":" '{ print $2 }' | awk -F"/" '{ print $1}'`
...
export USER_WRITER_SERVICE_PORT=`kubectl get services | grep "user-writer" | awk '{ print $5 }' | awk -F"," '{ print$2 }' | awk -F":" '{ print $2 }' | awk -F"/" '{ print $1}'`
...
export CLASSTIMETABLE_WRITER_SERVICE_PORT=`kubectl get services | grep "classtimetable-writer" | awk '{ print $5 }' | awk -F"," '{ print$2 }' | awk -F":" '{ print $2 }' | awk -F"/" '{ print $1}'`
